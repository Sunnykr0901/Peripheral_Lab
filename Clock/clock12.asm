...
CALL UPDDT
CALL DISP
BEGIN: LXI H,0100H        ;      Begin funtion : loads 0000H into HL register
...
CPI 13H                   ;      Compare the value in accumulator to 24 ( max hour hand is 24 )
...
MVI C,04H                 ;      Move the value 03H to register C

OUTLOOP:                  ;      OUTLOOP function
LXI D,7D10H               ;      Loads the value 9FFFH into DE register
