...
CALL UPDDT
JMP RESUME
CALL DISP 				  ;      Start the clock with the valus of H, L and A.
...
CALL UPDDT
DISP:                	  
CALL DELAY                ;      Call Delay for 1 Se
...
RESUME:                   ;      Function RESUME to wait for keyboard value before running the clock again
CALL RDKBD                
EI                       
LDA CURDT                   
JMP SEC                   
